...
# -----------------------------------------------------------------------------------------------------------------------------
# t3_t0 data
data_t3_t0 <- read.csv("../../Data/results/data_t3_t0.csv", header = TRUE, stringsAsFactors = FALSE, row.names = 1)
colnames(data_t3_t0)
group <- factor(c(1,1,1,2,2,2))
minSamplesInGroups <- 3

DEA_list_t3_t0 <- DEA(data_t3_t0, group, minSamplesInGroups, 0, 1)




# t2_t0 data
data_t2_t0 <- read.csv("../../Data/results/data_t2_t0.csv", header = TRUE, stringsAsFactors = FALSE, row.names = 1)
colnames(data_t2_t0)
group <- factor(c(1,1,1,2,2,2))
minSamplesInGroups <- 3

DEA_list_t2_t0 <- DEA(data_t2_t0, group, minSamplesInGroups, 0, 1)



# t1_t0 data
data_t1_t0 <- read.csv("../../Data/results/data_t1_t0.csv", header = TRUE, stringsAsFactors = FALSE, row.names = 1)
colnames(data_t1_t0)
group <- factor(c(1,1,1,2,2,2))
minSamplesInGroups <- 3

DEA_list_t1_t0 <- DEA(data_t1_t0, group, minSamplesInGroups, 0, 1)
...
write.csv(DEA_list_w_geneNames_t3_t0$up, file = "../../Data/results/DE_genes/heatmaps_up_data_t3_t0.csv", quote = TRUE)
write.csv(DEA_list_w_geneNames_t3_t0$down, file = "../../Data/results/DE_genes/heatmaps_down_data_t3_t0.csv", quote = TRUE)
...
# save up/down data.frames
write.csv(DEA_list_w_geneNames_t2_t0$up, file = "../../Data/results/DE_genes/heatmaps_up_data_t2_t0.csv", quote = TRUE)
write.csv(DEA_list_w_geneNames_t2_t0$down, file = "../../Data/results/DE_genes/heatmaps_down_data_t2_t0.csv", quote = TRUE)
...
# save up/down data.frames
write.csv(DEA_list_w_geneNames_t1_t0$up, file = "../../Data/results/DE_genes/heatmaps_up_data_t1_t0.csv", quote = TRUE)
write.csv(DEA_list_w_geneNames_t1_t0$down, file = "../../Data/results/DE_genes/heatmaps_down_data_t1_t0.csv", quote = TRUE)
